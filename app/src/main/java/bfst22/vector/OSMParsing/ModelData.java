...
/**
 * This class is responsible for keeping track of all model data including nodes, coastlines, adresses, graph for route finding
...
public class ModelData {
    ...
    /**
     * This method inserts the users point of interest in our radix tree so it is searchable.
     */
